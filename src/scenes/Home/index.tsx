  ...
  return (
    <section id="home" className="gap-16 bg-white-100 py-24 md:h-full md:pb-0">
      ...
      onViewportEnter={() => setCurrentPage(CurrentPage.Home)}>
        <motion.div className="items-center justify-center sm:ml-40"
          initial="hidden"
          whileInView="visible"
          ...
          <img className="h-50% rounded-full md:z-10 md:ml-20 md:justify-items-center md:h-80 md:w-100%" src={portrait_gray} alt="" />
        </motion.div>
        <div className="z-10 mt-10 ml-4 md:mt-24 md:ml-0">
          <motion.div className="mx-auto w-5/6 items-center justify-center md:h-5/6 md:w-4/6 md:-mt-24"
            initial="hidden"
            whileInView="visible"
            viewport={{once:true, amount: 0.5}} 
            ...
            <div className="relative">
              <div className="before:absolute before:-top-20 before:-left-20 before:z-[-1]">
                ...
                <h1 className="text-3xl font-bold justify-center md:justify-normal md:text-5xl">John Ivan Veluz</h1>
              </div>
            </div>
          </motion.div >
          <motion.div 
          ...
          className="mx-auto w-6/6 items-center justify-normal md:h-5/6 md:w-4/6 sm:justify-center">
              <p className="mt-4 ml-6 text-2xl items-center justify-normal md:text-3xl md:ml-0">
            ...
            >
              <span className="mx-auto ml-1 space-x-2 flex items-center justify-center md:justify-normal md:ml-8">
                  ...
                  <a href="https://github.com/IvanVeluz18" target="blank">
                    <button type="submit" className="mt-5 rounded-full">
                      <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="55" height="55" viewBox="0 0 32 32">
