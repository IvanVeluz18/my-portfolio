...
const Home = ({setCurrentPage}: Props) => {
  ...
  return (
    <section id="home" className="gap-16 bg-primary-100 py-24 md:h-full md:pb-0">
      <motion.div className="mx-auto w-4/6 items-center justify-center md:flex md:h-5/6"
      onViewportEnter={() => setCurrentPage(CurrentPage.Home)}>
        <motion.div className="before:absolute before:-top-20 before:-left-20 before:z-[-1]"
          initial="hidden"
          whileInView="visible"
          ...
          <img className="rounded-full object-scale-down h-80" src={portrait_gray} alt="" />
        </motion.div>
        <div className="z-10 mt-20 md:basis-3/5">
          <motion.div className="md:-mt-20 ml-20"
            initial="hidden"
            whileInView="visible"
            viewport={{once:true, amount: 0.5}} 
          ...
          <div className="mx-auto w-4/6 items-center justify-center md:h-5/6">
              <p className="mt-4 text-3xl items-center justify-center">
                Fullstack Web Developer | Software Engineer | AI/ML
            </p>
            <span className="mx-auto space-x-4 justify-center flex">
              <button type="submit"
