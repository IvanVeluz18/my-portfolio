    ...
    <section id="home" className="gap-16 bg-white-100 py-24 md:h-full md:pb-0">
      ...
      onViewportEnter={() => setCurrentPage(CurrentPage.Home)}>
        <motion.div className="items-center justify-center sm:ml-40"
          ...
          <img className="h-80 rounded-full md:z-10 md:ml-20 md:justify-items-center" src={portrait_gray} alt="" />
        </motion.div>
        <div className="z-10 mt-20">
          <motion.div className="mx-auto w-5/6 items-center justify-center md:h-5/6 md:w-4/6 md:-mt-20"
            initial="hidden"
            whileInView="visible"
            viewport={{once:true, amount: 0.5}} 
          ...
          <div className="mx-auto w-5/6 items-center justify-normal md:h-5/6 md:w-4/6 sm:justify-center">
              <p className="mt-4 text-3xl items-center justify-normal">
